...
public class App {
    ...
    public static void main(String[] args) {
       ...
       availableEvent.add(new Event("Worksop FullStack Developer", "25 Februari 2024", "Gedung Fakultas Ilmu Komputer Universitas Brawijaya", "10.00 - 13.00 WIB", 50, 5, 25.0));
